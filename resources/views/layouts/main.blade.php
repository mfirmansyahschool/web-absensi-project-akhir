...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/font-awesome/font-awesome.min.css')}}">
  <!-- CSS Files -->
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                    <a class="dropdown-item" href="{{ route('account.identitas') }}">Pengaturan Identitas</a>
                    <a class="dropdown-item" href="{{ route('account.akun') }}">Pengaturan Akun</a>
                    {{-- <a class="dropdown-item" href="#modal" data-toggle="modal">Settings</a> --}}
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="/about" target="_blank"><b>ABSENSI</b> WIKRAMA</a> for a better future.
          </div>
        </div>
      </footer>
    </div>
